...
## Step 3a: Add country labels (ggrepel)
...
## Step 3b: Add country labels (ggrepel)
...
ggplot(df, aes(gdpPercap, lifeExp, label = country)) +
  geom_point(size = 2, alpha = 0.8) +
  geom_label_repel(size = 3, max.overlaps = Inf) +
  scale_x_log10() +
  labs(
...
```{r solution}
ggplot(df, aes(gdpPercap, lifeExp, label = country, color = continent)) +
  geom_point(size = 2, alpha = 0.8) +
  geom_label_repel(size = 3, max.overlaps = Inf) +
  scale_x_log10() +
  labs(
